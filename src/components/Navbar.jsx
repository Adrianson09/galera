...
const navbarLinks = [
  ...
  { label: "Acerca de", href: "#about", ariaLabel: "about" },
  { label: "Horarios", href: "#horario", ariaLabel: "horario" },
  { label: "Precios", href: "#pricing", ariaLabel: "Pricing" },
  { label: "Contacto", href: "#contact", ariaLabel: "contact" },
          ...
          <a className="navbar-link" href="#home" aria-label="Home">
            <div className="flex justify-start items-center grow basis-0">
              <div className="text-white mr-2 text-6xl">
                <img src="../../src/assets/images/logo-galera-white.png" alt="Logo Galera" width={150} height={100}/>
              </div>
