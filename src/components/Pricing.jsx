...
const pricingData = [
  "Obtén evaluaciones detalladas y retroalimentación constante para mejorar tu técnica",
  "Recibe asesoramiento personalizado del profesor",
  "Garantiza un ambiente seguro y educativo",
  "Fomenta el desarrollo social y la disciplina a través del BJJ",
  "Participa en eventos y competiciones especiales",
];
        ...
        >
          <div className="container mx-auto px-4">
            <div className="max-w-2xl mx-auto text-center mb-16">
              ...
              Explora nuestras opciones de precios 
              </h2>
              <p className="mb-6 text-customGrayText">
              Estamos aquí para responder cualquier pregunta que puedas tener. Contáctanos y te responderemos lo antes posible.
              </p>
              ...
              <div className="w-[350px] sm:w-[380px] lg:w-1/3 px-4 mb-8 lg:mb-0">
                <div className="p-8 bg-customDarkBg3 rounded-3xl">
                  ...
                  <p className="mt-4 mb-6 2xl:mb-10 text-gray-500 leading-loose text-left">
                    Contáctanos para discutir una opción personalizada
                  </p>
